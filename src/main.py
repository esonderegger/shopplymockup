...
def mainHeader():
  ...
  print '<form name="searchLink"> | <input type="text" name="searchstring" value="Search..." onfocus="if (this.value == \'Search...\') {this.value = \'\';}" onKeyPress="return disableEnterKey(event)" onkeyup="shopplySearch()"></form>'
  print '</div>'
